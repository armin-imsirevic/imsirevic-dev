...
const usluge = defineCollection({
    loader: glob({ base: './src/content/usluge', pattern: '**/*.md' }),
    schema: ({ image }) =>
        z.object({
            title: z.string(),
            excerpt: z.string(),
            featuredImage: image().optional(),
            publishDate: z.string().transform(str => new Date(str)).nullable(),
...
const projekti = defineCollection({
    loader: glob({ base: './src/content/projekti', pattern: '**/*.md' }),
    schema: ({ image }) =>
        z.object({
            title: z.string(),
            excerpt: z.string(),
...
export const collections = { projekti, usluge, blog, team, legal };
